...
public class EmailServiceImpl implements EmailService {
    ...
    public void submitResetPwdEmail(String email) {
        ...
        to.add(email);
        userManager.submitResetPwdEmail(emailProducer.createEmailMq(to, UacEmailTemplateEnum.RESET_PWD_SEND_MAIL,
                AliyunMqTopicConstants.MqTagEnum.FORGOT_PASSWORD_AUTH_CODE, param));
    }
    ...
    public void sendEmailCode(SendEmailMessage sendEmailMessage, String loginName) {
        ...
        userManager.sendEmailCode(emailProducer.createEmailMq(to, UacEmailTemplateEnum.RESET_USER_EMAIL,
