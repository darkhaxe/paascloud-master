...
public class UacUserServiceImpl extends BaseService<UacUser> implements UacUserService {
    ...
    public void register(UserRegisterDto registerDto) {
        ...
        userManager.register(
                emailProducer.createEmailMq(to, UacEmailTemplateEnum.ACTIVE_USER,
                        AliyunMqTopicConstants.MqTagEnum.ACTIVE_USER, param),
                uacUser);
    }
    ...
    public void resetLoginPwd(Long userId, LoginAuthDto loginAuthDto) {
        ...
        userManager.resetLoginPwd(
                emailProducer.createEmailMq(to, UacEmailTemplateEnum.RESET_LOGIN_PWD,
                        AliyunMqTopicConstants.MqTagEnum.RESET_LOGIN_PWD, param),
                update);
    ...
    public void activeUser(String activeUserToken) {
        ...
        userManager.activeUser(
                emailProducer.createEmailMq(to,
                        UacEmailTemplateEnum.ACTIVE_USER_SUCCESS,
                        AliyunMqTopicConstants.MqTagEnum.ACTIVE_USER_SUCCESS,
                        param),
                update,
                activeUserKey);
    }
    ...
    public Collection<GrantedAuthority> loadUserAuthorities(Long userId) {
        return uacActionService.getOwnActionListByUserId(userId).stream()
                .map(action -> new SimpleGrantedAuthority(action.getUrl()))
